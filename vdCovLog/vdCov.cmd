...
gui_list_select -id CoverageTable.1 -list covtblFGroupsList { {/$unit::uart_rx_coverage::rx_cg}   }
gui_list_expand -id  CoverageTable.1   -list {covtblFGroupsList} {/$unit::uart_rx_coverage::rx_cg}
gui_list_expand -id CoverageTable.1   {/$unit::uart_rx_coverage::rx_cg}
gui_list_action -id  CoverageTable.1 -list {covtblFGroupsList} {/$unit::uart_rx_coverage::rx_cg}  -column {Group} 
verdiSetActWin -dock widgetDock_Message
